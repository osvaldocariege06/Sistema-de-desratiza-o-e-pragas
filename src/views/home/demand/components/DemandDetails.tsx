...
import DetailsDatesForm from './DetailsDatesForm'
import DetailsTeamForm from './DetailsTeamForm'
...
export default function DemandDetails({ props }: Props) {
  ...
  const {
    bottomSheetRef: bottomSheetRefTeam,
    onOpen: onOpenTeam,
    onClose: onCloseTeam,
  } = useBottomSheet()
  ...
  return (
    <>
      <View className="gap-3 py-4">
        ...
        <View className="border border-zinc-200 p-3 rounded-2xl">
          <View className="flex-row justify-between items-center">
            ...
            <TouchableOpacity onPress={onOpen}>
              <EditIcon size={16} color={colors.green[600]} />
            </TouchableOpacity>
          </View>
          ...
          <View className="flex-row gap-1 items-center mt-2">
            ...
            <Text className="text-sm font-semibold text-green-600">
              {formateDate(
                dayjs(props?.workBeginDate).add(10, 'days').toDate()
              )}
            </Text>
          </View>
          <View className="flex-row gap-1 items-center mt-2">
        ...
        <View className="border border-zinc-200 flex-row justify-between items-center p-3 rounded-2xl">
          <View className="">
            <View className="flex-row items-center gap-2">
          ...
          <TouchableOpacity className="px-2" onPress={onOpenTeam}>
            <PlusCircleIcon color={colors.green[600]} />
          </TouchableOpacity>
        </View>
